...
class AbstractUIEntry(Drawable):
    ...
    FONTS = {
        "default": pygame.font.Font(os.path.join(_FONT_FOLDER,
                                                 _DEFAULT_FONT),
                                    _DEFAULT_SIZE),
        "default8": pygame.font.Font(os.path.join(_FONT_FOLDER,
                                     _DEFAULT_FONT), 8)
    }
...
class Text(AbstractUIEntry):
    ...
    def __init__(self, position, text, font="default", color=(255, 255, 255)):
        ...
        self._image = AbstractUIEntry.FONTS[font].render(text, False,
                                                         self._color)
