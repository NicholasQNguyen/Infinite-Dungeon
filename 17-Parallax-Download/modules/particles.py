...
class Particle(Drawable):
   ...
   def __init__(self, startPosition, particleSize=(10,10), parallax=1):
      super().__init__("", Vector2(*startPosition), parallax=parallax)
...
class LingeringParticle(Particle):
   ...
   def __init__(self, startPosition, lingerTime, parallax=1):
      super().__init__(startPosition, parallax=parallax)
...
class Shower(Particle):
   def __init__(self, startPosition, initialVelocity=Vector2(0,0), parallax=1):
      super().__init__(startPosition, parallax=parallax)
...
class Rain(Particle):
   def __init__(self, startPosition, initialVelocity=Vector2(0,0), parallax=1, lineWidth=2):
      super().__init__(startPosition, (15, 15), parallax=parallax)
      ...
      pygame.draw.line(self._image, pygame.Color(200, 200, 255, 150), (0,0),
                       list(map(int, self._length)), lineWidth)
...
class ThinRain(Rain):
   def __init__(self, startPosition, initialVelocity=Vector2(0,0), parallax=1):
      super().__init__(startPosition, initialVelocity, parallax, 1)
...
class Snow(LingeringParticle):
   def __init__(self, startPosition, initialVelocity=Vector2(0,0), parallax=1):
      super().__init__(startPosition, 0.5, parallax=parallax)
