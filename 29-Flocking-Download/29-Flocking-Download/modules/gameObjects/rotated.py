...
def calculateAngle(pos1, pos2):
   # Returns in radians
   triangle = pos2 - pos1
   # Depending on which way the sprite initially faces, you may need to change this value
   #   0 for right facing
   #   math.pi / 2 for down facing
   #   math.pi for left facing
   #   math.pi * 1.5 for up facing
   addition = 0
...
class Rotatable(Drawable):
   ...
   def getCollisionRect(self):
      newRect =  self._truePosition + self._unrotatedImage.get_rect()
      return newRect
