...
class RectBarItem(AbstractItem):
   ...
   def draw(self, surface):
      drawPosition = self._position - Drawable.WINDOW_OFFSET * self._parallax
...
class FollowRectBarItem(RectBarItem, FollowItem):
   def __init__(self, followObject, followOffset, areaRect, initialValue, maxValue=10,
                color=(255,0,0), outline=(100,100,100), outlineWidth=2, backgroundColor=None):
      super().__init__(areaRect, initialValue, maxValue, color, outline, outlineWidth, backgroundColor)
      FollowItem.__init__(self, followObject, followOffset)
