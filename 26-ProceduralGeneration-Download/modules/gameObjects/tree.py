...
class Tree(Drawable):
   ...
   def __init__(self, position, surfaceSize=Vector2(200,200), parallax=1):
      ...
      self._angle = random.randint(45, 180)
      self._trunkSize = random.randint(20, 50)
      self._branchSize = random.randint(10, 20)
      self._branchNumber = random.randint(2, 5)
      self._levels = random.randint(1, 5)
      self._trunkWidth = random.randint(2, 5)
